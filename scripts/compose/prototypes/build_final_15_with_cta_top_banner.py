...
OUT = ROOT / "outputs/final_15_with_cta_top_banner"
FINAL = OUT / "final_15_original_only_with_cta_top_banner.mp4"
...
def main():
    ...
    filter_complex = (
        f"[1:v]scale={AD_WIDTH}:-2:flags=lanczos,"
        f"crop={AD_WIDTH}:{AD_HEIGHT}:0:{AD_CROP_Y},"
    ...
    manifest = {
        ...
        "cta_crop": {"scaled_width": AD_WIDTH, "crop_y": AD_CROP_Y},
    }
