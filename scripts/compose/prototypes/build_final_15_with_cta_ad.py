...
OUT = ROOT / "outputs/final_15_with_cta_ad"
FINAL = OUT / "final_15_original_only_with_cta_ad.mp4"
...
def main():
    ...
    filter_complex = (
        ...
        f"[0:v][ad]overlay=x=(main_w-overlay_w)/2:y={AD_TOP}:"
    ...
    manifest = {
        ...
        "cta_position": {"x": "center", "top": AD_TOP},
